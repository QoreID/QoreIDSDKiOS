...
#ifndef QOREIDSDK_SWIFT_H
#define QOREIDSDK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="QoreIDSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC9QoreIDSDK13CameraManager")
...
@interface CameraManager (SWIFT_EXTENSION(QoreIDSDK)) <AVCaptureMetadataOutputObjectsDelegate>
...
@class NSCoder;
SWIFT_CLASS("_TtC9QoreIDSDK13IHProgressHUD")
@interface IHProgressHUD : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame SWIFT_UNAVAILABLE;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder SWIFT_UNAVAILABLE;
@end

@class NSString;
SWIFT_CLASS("_TtC9QoreIDSDK20PhoneNumberFormatter")
...
@interface PhoneNumberFormatter (SWIFT_EXTENSION(QoreIDSDK))
...
SWIFT_CLASS("_TtC9QoreIDSDK14PhoneNumberKit")
